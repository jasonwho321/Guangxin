...
class WeChat():
    def __init__(self):
        ...
        配置初始信息
        """
        self.CORPID = "ww29eb018343ad0539"  # 企业ID
        self.CORPSECRET = "JbDYg2k1NFqy6k8kqZeAoh0f6fc7mN-Xp9nP9ZFZt3k"  # 应用Secret
        self.AGENTID = "1000002"  # 应用Agentid
        self.TOUSER = "HuZhang" # 接收消息的userid
...
if __name__ == '__main__':
    wx = WeChat()
    wx.send_file("C://Users//Admin//Pictures//微信图片_20210927103147.jpg")