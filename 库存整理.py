...
class write(object):
    def __init__(self):
        self.os_path = r'E:/OneDrive/广新/新品等级/库存历史 2022/'
        self.save_path = r'E:\OneDrive\广新\新品等级\2022年4月库存整合表.xlsx'
        self.path_list = []
        for dir in os.listdir(r'E:\OneDrive\广新\新品等级\库存历史 2022'):
    ...
    def open_book(self, app, path):
        ...
        outfile_or = df[(df[u'入库商家'] == u'QXD_39FINC')]
    ...
    def main(self):
        ...
        for path in self.path_list:
            ...
            sht.range(
                (i, 1)).options(
                pd.DataFrame, index=False, header=False).value = dataframe
            i += row
        book1.save()
        book1.close()
        app.quit()
