...
# 读取原始数据
data_file1 = '/Users/huzhang/Library/CloudStorage/坚果云-john.hu@39f.net/「晓望集群」/S数据分析/成本到箱/输出.csv'
data_file2 = '/Users/huzhang/Documents/我的 Tableau Prep 存储库/数据源/输出 2.csv'
output_file = '/Users/huzhang/Library/CloudStorage/坚果云-john.hu@39f.net/「晓望集群」/S数据分析/成本到箱/DDP-出库成本.csv'
...
# 按照货物名称和入库时间进行排序
sorted_table = merged_table.sort_values(['国家', '仓库类型', '英文名', '入库时间'], ascending=[True, True, True, False])
